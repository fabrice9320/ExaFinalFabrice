...
(async ()=>{
    try {
        ...
        const dataCountriesShuffle = (0, _lodash.shuffle)(countriesClean);
        console.log(dataCountriesShuffle);
        const test = new (0, _countryDefault.default)(dataCountriesShuffle);
        console.log(test);
        test.displayFlag();
...
},{"lodash":"3qBDj","./Country":"f22xG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Game":"l338F"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}],"l338F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _country = require("./Country");
var _countryDefault = parcelHelpers.interopDefault(_country);
class Game {
    ...
    constructor(propreties){
        ...
        this.countryIndex = 0;
        this.currentCountry = new (0, _countryDefault.default)(this.dataCountries[this.countryIndex]);
...
},{"./Country":"f22xG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3lsJq","bNKaB"], "bNKaB", "parcelRequire2013")
